...
Inclui o fluxo "Criar nova categoria" com nome e seletor de cor HEX.
"""
...
class TransactionSheet:
    ...
    def __init__(
        ...
        create_category: Callable[[str, str, TransactionType], object],
    ...
    # ------------------------------------------------------------------ público
    def open(self, type_: TransactionType, transaction: Transaction | None = None) -> None:
        self._type = type_
    ...
    def _save(self, _: ft.ControlEvent) -> None:
        ...
        if self.new_category_block.visible:
            ...
            category = self._create_category(name, color, self._type)
        ...
        self._on_submit(
            transaction_id=self._editing.id if self._editing else None,
